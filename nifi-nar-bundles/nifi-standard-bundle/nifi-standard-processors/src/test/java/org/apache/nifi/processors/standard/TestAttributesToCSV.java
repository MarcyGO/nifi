...
public class TestAttributesToCSV {
    ...
    public void testSchemaToAttribute() throws Exception {
        ...
        int temp1 = testRunner.getFlowFilesForRelationship(AttributesToCSV.REL_SUCCESS)
                .get(0).assertAttributeEqualsIn("CSVData",expected_CSVData);
        int temp2 = testRunner.getFlowFilesForRelationship(AttributesToCSV.REL_SUCCESS)
                .get(0).assertAttributeEqualsIn("CSVSchema",expected_CSVSchema);
